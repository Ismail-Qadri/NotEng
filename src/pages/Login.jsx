...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200 && result.random && result.sessionId) {
        ...
        const errorMessage =
          result.error || result.message || "Authentication failed";
  ...
  return (
    <div
      className="flex items-center justify-center min-h-screen bg-[#f9fcfd] font-['Segoe_UI',Arial,sans-serif]"
