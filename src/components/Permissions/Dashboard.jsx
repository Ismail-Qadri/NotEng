...
// const Dashboard = ({ can,  resources: passedResources, permissions: passedPermissions, refreshPermissions, isReady }) => {
...
//   useEffect(() => {
//     console.log("🔄 useEffect running - can:", !!can, "activeTab:", activeTab);
    
//     if (can && activeTab === null) {
//       const getDefaultTab = () => {
//         console.log("🔍 Checking permissions for default tab...");
//         if (can("User Management", "read")) {
//           console.log("✅ User Management accessible");
//           return "users";
//         }
//         if (can("Group Management", "read")) {
//           console.log("✅ Group Management accessible");
//           return "groups";
//         }
...
//           console.log("✅ Resource Management accessible");
//           return "resources";
//         }
...
//       console.log("🎯 Setting default tab:", tab);
//       setActiveTab(tab);
//     }
